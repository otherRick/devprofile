...
export const Projetos = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-start h-full w-96 '>
      ...
      <div className='p-6 flex flex-col items-center md:max-w-[1000px] md:w-max w-full'>
        <div className='relative md:w-full max-h-[400px] md:overflow-x-auto overflow-y-auto no-scrollbar shadow-inner'>
          <div className='md:flex md:flex-row flex-col gap-4 px-4 py-2 w-max'>
            {filteredProjects.map((project) => (
              <div
                key={project.id}
                className='p-4 rounded-lg shadow md:w-60 w-96 flex flex-col gap-2 snap-start group justify-between'
              >
